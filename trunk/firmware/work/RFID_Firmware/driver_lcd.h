...
#define LCD_E		        (0x20)
#define LCD_PSB		        (0x40)
#define LCD_nRET	        (0x80)

// position in register
#define LCD_BF		        (0x80)

// LCD pin operations
#define LCD_DPIN_DIR_OUT    (P2DIR = 0xFF)
#define LCD_DPIN_DIR_IN     (P2DIR = 0x00)
#define LCD_CPIN_DIR_OUT    (P6DIR |= (LCD_RS | LCD_RW | LCD_E | LCD_PSB | LCD_nRET))
